...
export default function LetoltesClient() {
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 justify-items-center">
            {[
              { src: screenshots.home, alt: t('screenshotAlts.home') },
              { src: screenshots.aac, alt: t('screenshotAlts.aac') },
              { src: screenshots.coloring, alt: t('screenshotAlts.coloring') },
              { src: screenshots.music, alt: t('screenshotAlts.music') },
              { src: screenshots.emotions, alt: t('screenshotAlts.emotions') },
              { src: screenshots.schedule, alt: t('screenshotAlts.schedule') },
            ].map((shot, i) => (
              <div
                key={i}
