...
export const moduleData: Record<ModuleKey, ModuleData> = {
  aac: {
    ...
    huFeatures: [
      '5000+ magyar és angol AAC szó képpel',
      'Predikciós sáv — okos mondatépítés',
      'Drag-and-drop tábla szerkesztő',
      'Szituációs sablonok (8 helyszín: otthon, iskola, orvos…)',
      'Quick Phrases — 77 előre kész mondat',
      'Fitzgerald Key színkódolás (PCS szabvány)',
    ],
    enFeatures: [
      '5000+ Hungarian and English AAC words with images',
      'Prediction bar — smart sentence building',
      'Drag-and-drop board editor',
      'Situational templates (8 locations: home, school, doctor…)',
      'Quick Phrases — 77 pre-built sentences',
